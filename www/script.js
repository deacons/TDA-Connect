$(document).ready(function() {
	$('iframe').load(function() {
		...
		$(myframe).find('#login').append('<h2 style="padding-bottom: 20px; padding-top: 0;">Hold cursor to right-click<br/>Scroll with two fingers<br/><br/>Created by George Garside</h2>');
